...
\subsection{Path}
Modul \textit{Path} menyediakan fungsi untuk mengatur akses suatu \textit{file} dan direktori. Modul tersebut dapat diakses dengan cara sebagai berikut:
...
Salah satu \textit{method} yang dimiliki oleh fungsi \textit{express()} yaitu sebagai berikut:
