...
Subbab-subbab berikut akan menjelaskan beberapa modul yang dimiliki oleh Node.js.
...
Kelas ini dibutuhkan untuk mengakses seluruh fitur yang disediakan oleh Express.js. Beberapa \textit{method} yang dimiliki oleh kelas \textit{express()} adalah sebagai berikut:

%Untuk dapat mengakses seluruh fitur Express.js, langkah yang harus dilakukan adalah sebagai berikut: 
