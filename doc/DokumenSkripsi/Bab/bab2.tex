...
Subbab berikut akan menjelaskan salah satu kelas yang ada pada \textit{interface} \textit{HTTP}.
...
Beberapa satu \textit{Method} yang dimiliki oleh \textit{HTTP} yaitu sebagai berikut:
\begin{itemize}
