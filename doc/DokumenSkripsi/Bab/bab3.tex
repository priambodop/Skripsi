...
Pada subbab ini akan dijelaskan beberapa pustaka yang digunakan dalam proses pengembangan aplikasi permainan berbasis web ini.
...
app.use('/', homeRouter);
\end{lstlisting}
			Potongan kode tersebut menunjukan bahwa apabila suatu \textit{client} mengakses \textit{port} yang tersedia, maka Express.js akan mengarahkan halaman web menuju homeRouter.
