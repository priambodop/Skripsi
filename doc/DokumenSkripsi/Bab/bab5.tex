...
\end{figure}
	...
	\begin{figure}[H]
		...
		\caption{Halaman permintaan bergabung}
	...
	\begin{figure}[H]
		...
		\caption{Halaman pemilihan karakter}
	...
	\begin{figure}[H]
		...
		\caption{Halaman memulai permainan}
	...
	\begin{figure}[H]
		...
		\caption{Halaman mengakhiri permainan}
...
\begin{enumerate}
	...
	\begin{itemize}
		\item \textbf{Masalah:} \\
		Tampilan halaman utama pada \textit{smartphone} terkadang muncul gambar jari. Masalah ini ditemukan pada \textit{smartphone} dengan resolusi layar yang berbeda-beda. Apabila ada \textit{smartphone} dengan resolusi lebih besar dibanding yang lainnya, maka gambar jari muncul dilayar.
