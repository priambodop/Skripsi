...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.3]{Gambar/realWeb1_home}
...
\end{figure}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[scale=0.3]{Gambar/realPhone1_home}
		\caption{Halaman \textit{Home}}
		\label{fig:realPhone1_home}
	\end{figure}

	\item \textbf{Halaman \textit{sync}}\\
	\textbf{PC} \\
	...
	\begin{figure}[H]
		\centering
		\includegraphics[scale=0.3]{Gambar/realWeb2_sync}
		\caption{Halaman \textit{Home}}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[scale=0.3]{Gambar/realPhone2_sync}
		\caption{Halaman \textit{Home}}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[scale=0.3]{Gambar/realWeb3_char}
		\caption{Halaman \textit{Home}}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[scale=0.3]{Gambar/realPhone3_char}
		\caption{Halaman \textit{Home}}
		\label{fig:realPhone3_char}
	\end{figure}
	
	\item \textbf{Halaman \textit{Gameplay}} \\
	\textbf{PC} \\
	...
	\begin{figure}[H]
		\centering
		\includegraphics[scale=0.3]{Gambar/realWeb4_game}
		\caption{Halaman \textit{Home}}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[scale=0.3]{Gambar/realPhone4_game}
		\caption{Halaman \textit{Home}}
		\label{fig:realPhone4_game}
	\end{figure}
	
	
	\item \textbf{Halaman \textit{Game Over}} \\
	\textbf{PC} \\
	...
	\begin{figure}[H]
		\centering
		\includegraphics[scale=0.3]{Gambar/realWeb5_over}
		\caption{Halaman \textit{Home}}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[scale=0.3]{Gambar/realPhone5_over}
		\caption{Halaman \textit{Home}}
